...
def attack(char_name: str, char_class: str) -> str:
    """Return string with random number depends on class."""
...
def special(char_name: str, char_class: str) -> str:
    """Return string depends on class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Print strings depends on class and start circle.
    Circle prints strings depends on input commands.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Help to choose class and return class."""
    approve_choice: str = ''
    char_class: str = ''
